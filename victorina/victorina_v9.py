...
while True:
    ...
    elif ask_age <= 30 and ask_age > 20:
        duw = input(f"Емае,тебе {ask_age}\nты хочешь узнать первый вопрос? - ")
        if duw == 'да':
            print('Отлично!')
            print('Я задам тебе пару вопросов для твоего возраста')
            adultv2_questions_one(ask_age)
            print('')
            adultv2_questions_four(ask_age)
            print('')
            dul = input('Тебе понравилось? - ')
            if dul.lower() == 'да':
                print('Отлично,давай продолжим!')
                print('')
                adultv2_questions_three(ask_age)
                print('')
                print('Это были все мои вопросы,надеюсь тебя все понравилось!')
                break
    ...
    elif ask_age <= 40 and ask_age > 30:
        duw = input(f"Здравствуй,тебе {ask_age}\nты хочешь узнать первый вопрос? - ")
        if duw == 'да':
            print('Отлично!')
            print('Я задам тебе пару вопросов для твоего возраста')
            adultv3_questions_one(ask_age)
            print('')
            adultv3_questions_four(ask_age)
            print('')
            dul = input('Тебе понравилось? - ')
            if dul.lower() == 'да':
                print('Отлично,давай продолжим!')
                print('')
                adultv3_questions_three(ask_age)
                print('')
                print('Это были все мои вопросы,надеюсь тебя все понравилось!')
                break
    ...
    elif ask_age <= 50 and ask_age > 40:
        duw = input(f"Бычтро время летит,тебе уже {ask_age}\nты хочешь узнать первый вопрос? - ")
        if duw == 'да':
            print('Отлично!')
            print('Я задам тебе пару вопросов для твоего возраста')
            adultv4_questions_one(ask_age)
            print('')
            adultv4_questions_four(ask_age)
            print('')
            dul = input('Тебе понравилось? - ')
            if dul.lower() == 'да':
                print('Отлично,давай продолжим!')
                print('')
                adultv4_questions_three(ask_age)
                print('')
                print('Это были все мои вопросы,надеюсь тебя все понравилось!')
                break
